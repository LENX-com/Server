        ...
        <>
            ...
            <div className="grid grid-cols-5 gap-3 mobile:grid-cols-1">
              <div className="col-span-4 mobile:col-span-full">
                ...
                <Review product={product} isTabletOrMobile ={ isTabletOrMobile }  setIsOpenSign = { setIsOpenSign } />
                <CustomerQuestions product = { product} isOpenSign={isOpenSign} setIsOpenSign={setIsOpenSign} />
