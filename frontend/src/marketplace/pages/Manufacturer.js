...
import { getSingleManufacturer } from "../../actions/userActions";
...
const Manufacturer = ({ match }) => {
  ...
  const { isAuthenticated } = useSelector((state) => state.auth);
  useEffect(() => {
    dispatch(getSingleManufacturer(match.params.manufacturerId));
  }, [dispatch,match.params.manufacturerId]);
    ...
    <Card className="grid grid-cols-3 gap-3 rounded-none my-2">
      <div
        className={`text-center font-bold ${
          menu === 0 && "border-b-2 border-orange text-orange "
        }`}
        onClick={() =>
          setSection({
            menu: 0,
      ...
      <div
        className={`text-center font-bold ${
          menu === 1 && "border-b-2 border-orange text-orange "
        }`}
        onClick={() =>
          setSection({
            menu: 1,
      ...
      <div
        className={`text-center font-bold ${
          menu === 2 && "border-b-2 border-orange text-orange "
        }`}
        onClick={() =>
          setSection({
            menu: 2,
...
export default Manufacturer;
>>>>>>> 8394fb650a859434daa153abc4d2256f5c9dac73
