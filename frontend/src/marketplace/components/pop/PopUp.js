        ...
        <Transition appear show={isOpen} as={Fragment}>
          ...
          >
            <div className="text-center">
              ...
              >
                <div
                      className={`fixed inset-0 m-auto  w-full max-w-md overflow-hidden text-left align-middle transition-all transform bg-white shadow-button  overflow-y-scroll rounded-md`}
                      style ={{height:"60vh"}}
                      >
                  <Dialog.Title
                    as="div"
      ...
      <Mobile>
          ...
          >
            <div className="text-center">
              ...
              >
                <div
                      className={`mobile:absolute mobile:bottom-0  w-full max-w-lg overflow-hidden text-left align-middle transition-all transform bg-background shadow-xl  overflow-y-scroll`}
                      style= {{height:'60vh'}}
                      >
                  <Dialog.Title
                    as="div"
