        ...
        <div>      
            <div className="banner-slider">
                ...
                >
                {
                    ...
                    <SwiperSlide>    
                        <div className="bg-cover bg-center  h-32 text-white px-10 object-fill banner flex">
                                <div className="flex md:w-1/2 my-auto mr-3 w-full">
                                    <div>
                                        <p className="font-bold text-sm uppercase"> { title } </p>
                                        <p className="text-2xl mb-10 leading-none"> { description } </p>
                                    </div>
                                </div>
                                <div className=" h-20 w-20 my-auto">
