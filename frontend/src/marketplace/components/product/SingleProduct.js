...
const SingleProduct = ({ product,  isTabletOrMobile, handleProfile, handleChat}) => {
...
//   }
  ...
  const MobileVersion = () => (
    ...
    <div className="flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 shadow-separator">
                <div>
              ...
              <div className=" p-2">
                  ...
                  <div className="flex mb-4">
                    <span className="flex items-center">
                      ...
                      <Link to={`/marketplace/products/reviews/${product._id}`} className="underline text-Black-medium"> { product.comments.length === 1 ? `(${product.comments.length} review)` : `(${product.comments.length} reviews)` }</Link>
                      </span>
                  </div>
              ...
              <div className="col-span-1">
                <div className="border-box p-2">
                  {/* <div className="flex m-auto text-center justify-center">
                    <FaShippingFast className="text-lg text-Blue my-auto"/>
                    <span className="text-Blue ml-2"> Free Delivery </span>
                  </div> */}
