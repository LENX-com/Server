...
import { MdStarBorder, MdStar, MdShoppingCart, MdFavoriteBorder, MdArrowBack} from 'react-icons/md'
    ...
    return (
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="rounded-full shadow-button inline-block">
                ...
                <button
                    className="border-r-2 focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent rounded-l-full"
                    onClick= {() => setCount(Math.max(1, count - 1))}>
                    -
                </button>
                <h2 className="my-auto px-3 text-lg"> { count } </h2>
                <button
                  className="border-l-2 focus:outline-none focus:ring-2 focus:ring-orange focus:border-transparent rounded-r-full"
            ...
            <div className="grid gap-30">
                <Button className="bg-Blue text-Grey my-2">
                  Buy now
                </Button>
                <Button className="bg-Blue bg-opacity-20 text-Blue mb-2">
                  Add to Cart
                </Button>
            </div>
        </Card>
