...
const FAQ = () => {
        ...
        <div class="text-center ">
          <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">
            ...
            <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
              As a marketplace of thousands of individual makers, we are invested in making sure every purchase is a great experience.
            </p>
        </div>
    ...
    <div className="container mx-auto p-10 md:p-20 grid lg:grid-cols-2 2xl:grid-cols-2 grid-cols-1 gap-y-10 transform duration-500">
          <InfoCard className="mr-4" title="Existing clients" value="Please interact with the manufacturer" button="Contact manufacturer" />

          <InfoCard className="mr-4" title="New clients" value="Do you have any pre-sales questions?"  button="Ask a question"  />
    </div>
    </div>
    )
}
