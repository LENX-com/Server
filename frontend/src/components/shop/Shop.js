    ...
    return (
            <div className="mx-auto max-w-[1920px] px-4 md:px-8 2xl:px-16">
                <div className="flex pt-8 pb-16 lg:pb-20">
                    <div className="flex-shrink-0 pe-24 hidden lg:block w-96">
                        <div className="position: sticky; top: 50px;">
                            ...
                            <h3 className="text-heading text-sm md:text-base font-semibold mb-7">Filter by categories</h3>
                    ...
                    <div className="bg-white m-5 p-3.5 block border-b border-gray-300 pb-7 mb-7">
                      <h3 className="text-heading text-sm md:text-base font-semibold mb-7">Filter by price range</h3>
                      <div className="mt-2 flex flex-col space-y-4>">
                        <RadioBox
                            prices={prices}
                            handleFilters={filters =>
                ...
                <div className="w-full lg:-ms-9">
                    ...
                    <h2 className="text-2xl font-bold text-heading hidden lg:inline-flex pb-1">Products</h2>
